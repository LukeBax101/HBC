...
CREATE TABLE session_songs (session_song_id UUID PRIMARY KEY, session_ID UUID REFERENCES sessions(session_id), song_id UUID REFERENCES songs(song_id), song_no INTEGER, CONSTRAINT UC_Session_Song UNIQUE (session_id, song_id));
